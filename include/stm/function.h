...
namespace stm
{
	...
	inline float logistic_primef(float value) { return logisticf(value) * (1.0f - logisticf(value)); }
	inline double logistic_prime(double value) { return logistic(value) * (1.0 - logistic(value)); }
}
